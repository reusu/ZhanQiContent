...
public class ToolTip {
	//设置配置文件读取路径
	InputStream inputStream=new BufferedInputStream(new FileInputStream("tip.properties"));
	...
	public ToolTip() throws Exception {
		...
		//设置是否置顶
		if(properties.getProperty("Tip_useTop").toLowerCase().equals("true")){
			_useTop=true;
		}
		//设置动画步长时间
	...
	class ToolTipSingle extends JWindow {
		...
		private void initComponents() {
			...
			//判断是否使用外部背景图片
			if(properties.getProperty("Tip_useBackGroundImg").toLowerCase().contains("false")){
			...
			externalPanel.add(_message, BorderLayout.CENTER);
	...
	class Animation extends Thread {
		...
		public void run() {
			...
			if(properties.getProperty("Tip_maxTipOperate").toLowerCase().equals("drop")&&_countOfToolTip>=_maxToolTipSceen){
				...
				//表情过滤
				if(_single._message.getText().contains("useitem")&&properties.getProperty("Tip_passItem").toLowerCase().contains("true")){
					//什么都不做 结束线程
				}else{
					try {
...
//		tip.setToolTip("“程序员”就是特指越写程序身材越“圆”那群人 -- 1");
//		Thread.sleep(100);
//		tip.setToolTip("[emot:good]“程序员”就是特指越写程序身材越“圆”那群人 -- 2");
//		Thread.sleep(100);
//		tip.setToolTip("“程序员”就是特指越写程序身材越“圆”那群人 -- 3");
//		Thread.sleep(100);
//		tip.setToolTip("[emot:good]“程序员”就是特指越写程序身材越“圆”那群人 -- 4");
//		Thread.sleep(100);
//		tip.setToolTip("“程序员”就是特指越写程序身材越“圆”那群人 -- 5");
//		Thread.sleep(100);
//		tip.setToolTip("[emot:good]“程序员”就是特指越写程序身材越“圆”那群人 -- 6");
//		Thread.sleep(100);
//		tip.setToolTip("“程序员”就是特指越写程序身材越“圆”那群人 -- 7");
//		Thread.sleep(100);
//		tip.setToolTip("[emot:good]“程序员”就是特指越写程序身材越“圆”那群人 -- 8");
//		Thread.sleep(100);
//		tip.setToolTip("“程序员”就是特指越写程序身材越“圆”那群人 -- 9");
//		Thread.sleep(100);
//		tip.setToolTip("[emot:good]“程序员”就是特指越写程序身材越“圆”那群人 -- 10");
//
//	}
}
